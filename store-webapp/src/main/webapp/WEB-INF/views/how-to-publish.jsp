...
<!DOCTYPE html>
<html class="how-to-publish-page" lang="${language}">
	<head>
	    <title>Quiero publicar | ba.tours</title>
	...
	<body>
	    ...
	    <script type="text/javascript" src="assets/js/store/how-to-publish.js"></script>
	</body>
</html>