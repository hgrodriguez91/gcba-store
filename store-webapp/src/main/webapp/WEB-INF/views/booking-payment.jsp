...
<!DOCTYPE html>
<html class="booking-payment" lang="${language}">
	<head>
		<title>Pago y confirmacion | ba.tours</title>
	...
	<body class="">
		...
		<main id="app" class="main-padding bg-box bg-box-lighter-grey"></main>
		<footer></footer>
		...
		<script type="text/javascript" src="assets/js/store/booking-payment.js"></script>
	</body>
</html>